	...
	?>
		<main class="main-container-no-padding main-container">
			...
			<div class="info-page-container">
				<div class="info-page">
					<div class="info-page-title-container">
						<h1 class="info-page-title">Lorem</h1>
					</div>
				...
				<div class="info-page info-page-alt">
					<div class="info-page-title-container info-page-title-container-alt">
						<h1 class="info-page-title">Lorem</h1>
					</div>
