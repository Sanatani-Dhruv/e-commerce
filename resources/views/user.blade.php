...
@php include_once("php/general-session-variable.php");
	...
	$get_from_cart_result = mysqli_query($conn, $get_from_cart_sql); @endphp
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8">
...
@php if (mysqli_num_rows($get_from_cart_result) > 0) { @endphp
			<h1 id="cart" class="cart-page-title">Your Cart</h1>
			<div class="cart-page-container">
@php while ($row = mysqli_fetch_assoc($get_from_cart_result)) { @endphp
